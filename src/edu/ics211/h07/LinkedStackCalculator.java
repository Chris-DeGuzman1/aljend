 ...
 * @summary Copy of Calculator.java except tweaked to use LinkedStack.java
 *          instead of Stack from the Java standard library
 *
 */
public class LinkedStackCalculator {
	...
	private enum Operator {
		EXPONENT, MULTIPLY, DIVIDE, MODULO, ADD, SUBTRACT, BLANK
	};
